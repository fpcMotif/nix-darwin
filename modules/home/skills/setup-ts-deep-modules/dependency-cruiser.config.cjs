...
module.exports = {
  ...
  options: {
    ...
    // Cruise the pre-compilation graph: a type-only (or unused) deep import
    // must still break the boundary. Without this, TypeScript compilation
    // elides those imports and they pass every rule silently.
