...
-- Jumping
map_set("jk", "WindowJumpTop", 1)
map_set("jj", "WindowJumpBottom", 1)
map_set("jh", "WindowJumpLeft", 1)
map_set("jl", "WindowJumpRight", 1)

-- Resizing
map_set("rk", "WindowResizeTop", 2)
map_set("rj", "WindowResizeBottom", 2)
map_set("rh", "WindowResizeLeft", 2)
map_set("rl", "WindowResizeRight", 2)

-- Moving
map_set("mk", "WindowMoveTop", 2)
map_set("mj", "WindowMoveBottom", 2)
map_set("mh", "WindowMoveLeft", 2)
map_set("ml", "WindowMoveRight", 2)
