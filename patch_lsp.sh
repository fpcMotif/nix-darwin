...
+  home.activation.codexLspConfig = lib.mkIf pkgs.stdenv.hostPlatform.isDarwin (hm.dag.entryAfter [ "writeBoundary" ] ''
...
+  '');
INNER_EOF
patch modules/home/lsp.nix lsp_patch.diff
