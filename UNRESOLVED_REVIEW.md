...
- `modules/home/skills.nix`: explicit skill package injection uses the upstream `agent-skills-nix` DSL but still needs a real `nix build`/activation check to verify generated `SKILL.md` dependency tables and package symlinks.
